...
class PackageService {
    ...
    static GetSharedInstance() {
        if (!PackageService.sharedInstance) {
            PackageService.sharedInstance = new PackageService((0, constants_2.getResourceServiceEndpoint)(constants_2.ResourceServiceType.MOS3), globalVars_1.TOOLS.logProvider);
        }
    ...
    async sideLoadingV2(token, manifestPath, appScope) {
        ...
        try {
            ...
            const serviceUrl = await this.getTitleServiceUrl(token);
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.debug(`"Uploading package with sideLoading V2 in ${appScope} scope ..."`);
            ...
            const statusId = uploadResponse.data.statusId;
            (_b = this.logger) === null || _b === void 0 ? void 0 : _b.debug(`Acquiring package with statusId: ${statusId} ...`);
            do {
                ...
                const resCode = statusResponse.status;
                (_c = this.logger) === null || _c === void 0 ? void 0 : _c.debug(`Package status: ${resCode} ...`);
                if (resCode === 200) {
                    const titleId = statusResponse.data.titleId;
                    const appId = statusResponse.data.appId;
                    (_d = this.logger) === null || _d === void 0 ? void 0 : _d.info(`TitleId: ${titleId}`);
                    (_e = this.logger) === null || _e === void 0 ? void 0 : _e.info(`AppId: ${appId}`);
                    (_f = this.logger) === null || _f === void 0 ? void 0 : _f.verbose("Sideloading done.");
                    return [titleId, appId];
                }
                else {
            ...
            if (err instanceof teamsfx_api_1.UserError) {
                err.helpLink = constants_1.M365HelpLink;
            }
            throw err;
        }
    }
    async sideLoadingV1(token, manifestPath) {
        ...
        try {
            ...
            content.append("package", data);
            const serviceUrl = await this.getTitleServiceUrl(token);
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.debug("Uploading package with sideLoading V1 ...");
            const uploadHeaders = content.getHeaders();
            uploadHeaders["Authorization"] = `Bearer ${token}`;
        ...
        try {
            ...
            try {
                ...
                if (error.response && error.response.status === 404) {
                    (_b = this.logger) === null || _b === void 0 ? void 0 : _b.debug(`TitleId ${titleId} not found, skip deleting.`);
                }
                else {
                    throw error;
                }
            }
            (_c = this.logger) === null || _c === void 0 ? void 0 : _c.verbose("Unacquiring done.");
        }
        catch (error) {
            if (error.response) {
                error = this.traceError(error);
    ...
    async removePermission(token, titleId, user) {
        ...
        try {
            ...
            const serviceUrl = await this.getTitleServiceUrl(token);
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.verbose(`Removing permission to user ${user.displayName} ...`);
    ...
    async addOwner(token, titleId, user) {
        ...
        try {
            ...
            const serviceUrl = await this.getTitleServiceUrl(token);
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.verbose(`Granting permission to user ${user.displayName} ...`);
            await this.axiosInstance.put(`/builder/v1/users/titles/${titleId}/owners?idType=TitleId`, {
                Owners: newOwners,
            }, {
                baseURL: serviceUrl,
    ...
    async shareWithTenant(token, titleId) {
        var _a;
        try {
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.verbose(`Change shared scope of agent to tenant with titleId: ${titleId} ...`);
            const serviceUrl = await this.getTitleServiceUrl(token);
    ...
    async getSharedUsers(token, titleId) {
        var _a;
        try {
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.verbose(`Getting shared users with titleId: ${titleId} ...`);
            const serviceUrl = await this.getTitleServiceUrl(token);
    ...
    async shareWithUsers(token, entities, titleId, appId) {
        var _a;
        try {
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.verbose(`Adding shared users to app with titleId: ${titleId} ...`);
            const serviceUrl = await this.getTitleServiceUrl(token);
            await this.axiosInstance.post(`/builder/v1/users/titles/${appId !== null && appId !== void 0 ? appId : titleId}/allowed?idType=${appId ? "AppId" : "TitleId"}`, {
                EntityCollection: {
                    ForAllUsers: false,
                    Entities: entities,
                },
    ...
    async unshare(token, titleId) {
        var _a;
        try {
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.verbose(`Removing shared users from app with titleId: ${titleId} ...`);
            const serviceUrl = await this.getTitleServiceUrl(token);
    ...
    traceError(error) {
        ...
        const innerError = ((_c = error.response.data) === null || _c === void 0 ? void 0 : _c.error) ||
        ...
        if (((_d = error.response) === null || _d === void 0 ? void 0 : _d.status) === 400) {
            ...
            error = new teamsfx_api_1.UserError({
                ...
                error,
                source: M365ErrorSource,
                message: (0, localizeUtils_1.getDefaultString)("error.m365.SharedScopeAdvancedDADisabled", constants_1.advancedDASettingUrl),
                displayMessage: (0, localizeUtils_1.getLocalizedString)("error.m365.SharedScopeAdvancedDADisabled", constants_1.advancedDASettingUrl),
            });
        }
        return error;
    }
