...
class OfficeAddinGeneratorNew extends defaultGenerator_1.DefaultTemplateGenerator {
    ...
    async getTemplateInfos(context, inputs, destinationPath, actionContext) {
        ...
        if (templateName === templateNames_1.TemplateNames.DeclarativeAgentMetaOSUpgradeProject) {
            return Promise.resolve((0, teamsfx_api_1.ok)([]));
        }
        // Handle new project - needs scaffolding
        if (templateName === templateNames_1.TemplateNames.DeclarativeAgentMetaOSNewProject) {
            return Promise.resolve((0, teamsfx_api_1.ok)([
                {
