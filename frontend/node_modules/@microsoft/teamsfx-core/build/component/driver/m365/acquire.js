...
let M365TitleAcquireDriver = class M365TitleAcquireDriver {
    constructor() {
        this.description = (0, localizeUtils_1.getLocalizedString)("driver.m365.acquire.description");
        this.progressTitle = (0, localizeUtils_1.getLocalizedString)("driver.m365.acquire.progress.message");
    }
    ...
    async handler(args, context, outputEnvVarNames) {
        ...
        try {
            ...
            if (error instanceof teamsfx_api_1.UserError || error instanceof teamsfx_api_1.SystemError) {
                (_a = context.logProvider) === null || _a === void 0 ? void 0 : _a.error((0, localizeUtils_1.getLocalizedString)(constants_2.logMessageKeys.failExecuteDriver, exports.actionName, error.displayMessage));
                throw error;
            }
            const message = JSON.stringify(error);
            (_b = context.logProvider) === null || _b === void 0 ? void 0 : _b.error((0, localizeUtils_1.getLocalizedString)(constants_2.logMessageKeys.failExecuteDriver, exports.actionName, message));
