...
let CreateOauthDriver = class CreateOauthDriver {
    ...
    async execute(args, context, outputEnvVarNames) {
        ...
        try {
            ...
            if (state && state.configurationId) {
                ...
                const scope = process.env[constants_2.QuestionNames.OAuthScope];
                if (scope) {
                    args.scope = scope;
                }
                ...
                const authInfo = await (0, utility_1.getAuthInfo)(args, context, actionName);
                if (args.identityProvider === "MicrosoftEntra") {
                    if (authInfo.authorizationEndpoint &&
                ...
                if (args.identityProvider === "MicrosoftEntra" &&
                    ...
                    void context.ui.showMessage("warn", (0, localizeUtils_1.getLocalizedString)(constants_3.logMessageKeys.microsoftEntraWarning, oauthRegistrationRes.resourceIdentifierUri, constants_3.defaultRedirectUri), false);
                }
    ...
    validateArgs(args) {
        ...
        if (args.authorizationUrl &&
            (typeof args.authorizationUrl !== "string" || !(0, utility_1.validateUrl)(args.authorizationUrl))) {
            invalidParameters.push("authorizationUrl");
        }
        if (args.tokenUrl && (typeof args.tokenUrl !== "string" || !(0, utility_1.validateUrl)(args.tokenUrl))) {
        ...
        if (args.tokenExchangeMethodType &&
            args.tokenExchangeMethodType !== OauthRegistration_1.TokenExchangeMethodType.BasicAuthorizationHeader &&
            args.tokenExchangeMethodType !== OauthRegistration_1.TokenExchangeMethodType.PostRequestBody) {
    ...
    async mapArgsToOauthRegistration(tokenProvider, args, authInfo) {
        ...
        const tokenExchangeMethodType = args.tokenExchangeMethodType
            ...
            : OauthRegistration_1.TokenExchangeMethodType.BasicAuthorizationHeader;
        if (args.identityProvider === "MicrosoftEntra") {
            return {
