...
exports.generateConfigFiles = void 0;
...
async function generateConfigFiles(inputs) {
    ...
    if (includePlayground) {
        if (features.hasBot) {
            ...
            await ((_a = globalVars_1.TOOLS.ui) === null || _a === void 0 ? void 0 : _a.showMessage("warn", `Playground is not supported for the current app manifest of ${appName}. Skipping Playground configuration file generation.`, false));
        }
    }
    ...
    await configGenerator_1.configGenerator.run(context, projectPath, configComponents, Object.assign(Object.assign({}, features), { appName }));
