...
export declare class FxCore extends FxCoreDeclarativeAgentPart {
     ...
     * Add plugin
     */
    addPlugin(inputs: Inputs): Promise<Result<undefined | any, FxError>>;
    regeneratePlugin(inputs: Inputs): Promise<Result<undefined | any, FxError>>;
    /**
     * MetaOS Extend To DA
     */
    metaOSExtendToDA(inputs: Inputs, workDir: string): Promise<Result<undefined | any, FxError>>;
    /**
     * Add Knowledge
     */
    ...
    private updateAuthActionInYaml;
