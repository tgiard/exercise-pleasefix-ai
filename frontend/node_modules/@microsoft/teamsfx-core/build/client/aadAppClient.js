...
class AadAppClient {
    constructor(m365TokenProvider, logProvider) {
        this.retryNumber = 5;
        this.baseUrl = `${(0, constants_1.getResourceServiceEndpoint)(constants_1.ResourceServiceType.Graph)}/v1.0`;
    ...
    async createAadApp(displayName, signInAudience = signInAudience_1.SignInAudience.AzureADMyOrg, serviceManagementReference, isMicrosoftUser = false) {
        var _a, _b, _c;
        const requestBody = {
        ...
        try {
            ...
            if (axios_1.default.isAxiosError(err) && err.response) {
                if (((_b = (_a = err.response.data) === null || _a === void 0 ? void 0 : _a.error) === null || _b === void 0 ? void 0 : _b.code) === constants_2.aadErrorCode.signInAudienceNotAllowedAsPerAppPolicy) {
                    throw new signInAudienceNotAllowedError_1.SignInAudienceNotAllowedError(AadAppClient.name, (_c = err.response.data.error) === null || _c === void 0 ? void 0 : _c.message, isMicrosoftUser);
                }
            }
            throw err;
        }
    ...
    clientSecretDescription = "default", isMicrosoftUser = false) {
        var _a, _b, _c, _d;
        ...
        try {
            ...
            if (axios_1.default.isAxiosError(err) && err.response) {
                ...
                if (((_d = (_c = err.response.data) === null || _c === void 0 ? void 0 : _c.error) === null || _d === void 0 ? void 0 : _d.code) === constants_2.aadErrorCode.credentialTypeNotAllowedAsPerAppPolicy) {
                    throw new clientSecretNotAllowedError_1.ClientSecretNotAllowedError(AadAppClient.name, isMicrosoftUser);
                }
            }
            throw err;
        }
