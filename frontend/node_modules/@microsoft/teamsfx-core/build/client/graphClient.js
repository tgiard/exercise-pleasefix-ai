...
class GraphClient {
    constructor(tokenProvider, logProvider) {
        var _a;
        this.baseUrl = (_a = process.env.GRAPH_ENDPOINT) !== null && _a !== void 0 ? _a : `${(0, constants_1.getResourceServiceEndpoint)(constants_1.ResourceServiceType.Graph)}/beta`;
    ...
    async CreateTeamAndChannelAsync(teamName, description, defaultChannelName) {
        ...
        const requester = this.createRequesterWithToken(tokenResponse.value);
        const teamData = {
            "template@odata.bind": `${(0, constants_1.getResourceServiceEndpoint)(constants_1.ResourceServiceType.Graph)}/beta/teamsTemplates('standard')`,
