...
class VSCapabilityOptions {
    ...
    static travelAgentBot() {
        return {
            id: "custom-copilot-travel-agent",
            label: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.capability.customCopilotTravelOption.label"),
            detail: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.capability.customCopilotTravelOption.detail"),
            data: templateNames_1.TemplateNames.TravelAgent,
        };
    }
    static foundryProxyAgent() {
        return {
            id: "foundry-proxy-agent",
            label: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.capability.foundryProxyAgentOption.label"),
            detail: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.capability.foundryProxyAgentOption.detail"),
            data: templateNames_1.TemplateNames.FoundryProxyAgent,
        };
    }
}
