...
(function (QuestionNames) {
    ...
    QuestionNames["TeamsCapability"] = "teams-capability";
    ...
    QuestionNames["SolutionName"] = "solutionName";
    ...
    QuestionNames["OpenAIAssistantID"] = "openai-assistant-id";
    ...
    QuestionNames["AzureOpenAIAssistantId"] = "azure-openai-assistant-id";
    QuestionNames["AzureAISearchApiKey"] = "azure-ai-search-api-key";
    QuestionNames["AzureAISearchEndpoint"] = "azure-ai-search-endpoint";
    QuestionNames["FoundryEndpoint"] = "foundry-endpoint";
    QuestionNames["FoundryAgentId"] = "foundry-agent-id";
    ...
    QuestionNames["ShareOperation"] = "share-operation";
    QuestionNames["ShareScope"] = "scope";
    QuestionNames["RemoveUsers"] = "users";
    QuestionNames["SelectPluginManifest"] = "select-plugin-manifest";
    QuestionNames["SelectOpenAPISpecFromPlugin"] = "select-openapi-spec-from-plugin";
    QuestionNames["SelectPluginId"] = "select-plugin-id";
    QuestionNames["DAMetaOSCapability"] = "da-meta-os-capability";
    QuestionNames["MCPServerType"] = "mcp-server-type";
    QuestionNames["MCPLocalServer"] = "mcp-local-server";
    QuestionNames["MCPLocalServerIdentifier"] = "mcp-local-server-identifier";
    QuestionNames["MCPForDAServerUrl"] = "mcp-da-server-url";
    QuestionNames["MCPForDAServerName"] = "mcp-da-server-name";
    QuestionNames["MCPForDATool"] = "mcp-da-tool";
    QuestionNames["MCPForDAAvailableTools"] = "mcp-da-available-tools";
    QuestionNames["MCPForDAPreFetchTools"] = "mcp-da-pre-fetch-tools";
    QuestionNames["MCPForDAAuth"] = "mcp-da-auth";
    QuestionNames["MCPForDAAuthMetadataUrl"] = "mcp-da-auth-metadata-url";
    QuestionNames["MCPForDAAuthWellKnownUrl"] = "mcp-da-auth-well-known-url";
    QuestionNames["MCPForDAAuthType"] = "mcp-da-auth-type";
