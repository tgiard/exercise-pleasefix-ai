import { SovereignCloudEnvironment } from "./accountUtils";
...
export declare enum ResourceServiceType {
    AuthSvc = "AuthSvc",
...
export declare const serviceEndpoints: Record<SovereignCloudEnvironment, Record<ResourceServiceType, string>>;
export declare function getResourceServiceEndpoint(resourceServiceType: ResourceServiceType): string;
export declare const AuthSvcScopes: () => string[];
export declare const AppStudioScopes: () => string[];
export declare const MosServiceScope: () => string[];
export declare const GraphScopes: string[];
export declare const GroupSearchScopes: string[];
export declare const GCScopes: string[];
export declare const GraphReadUserScopes: string[];
export declare const GraphTeamsAppSettingsReadScopes: string[];
export declare const GraphTeamsTeamCreateScopes: string[];
export declare const GraphTeamsChannelCreateScopes: string[];
export declare const GraphTeamsTeamReadScopes: string[];
export declare const GraphTeamsChannelReadScopes: string[];
export declare const GraphTeamsInstallAppScopes: string[];
export declare const ListSensitivityLabelScope = "InformationProtectionPolicy.Read";
