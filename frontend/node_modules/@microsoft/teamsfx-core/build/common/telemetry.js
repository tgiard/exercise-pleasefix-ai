...
(function (TelemetryProperty) {
    ...
    TelemetryProperty["AddAuthType"] = "add-auth-type";
    TelemetryProperty["MosTitleId"] = "mos-title-id";
    TelemetryProperty["MosAppId"] = "mos-app-id";
    TelemetryProperty["IsDeclarativeAgent"] = "is-declarative-agent";
    TelemetryProperty["SkipCreation"] = "skip-creation";
    TelemetryProperty["DeleteInstalledApp"] = "delete-installed-app";
    TelemetryProperty["IsKiotaNPMIntegrationEnabled"] = "kiota-npm-integration-enabled";
...
(function (TelemetryEvent) {
    ...
    TelemetryEvent["GenerateConfig"] = "generate-config";
    TelemetryEvent["GenerateConfigSummary"] = "generate-config-summary";
    ...
    TelemetryEvent["AddAuthAction"] = "add-auth-action";
    TelemetryEvent["ViewAgentManifestAfterAdded"] = "view-agent-manifest-after-added";
    TelemetryEvent["MosSideloadEnd"] = "mos-sideload-end";
...
(function (ProjectTypeProps) {
    ...
    ProjectTypeProps["DeclarativeAgentCapabilitiesCount"] = "declarative-agent-capabilities-count";
    ProjectTypeProps["DeclarativeAgentCapabilities"] = "declarative-agent-capabilities";
    ProjectTypeProps["DeclarativeAgentActionsCount"] = "declarative-agent-actions-count";
    ProjectTypeProps["DeclarativeAgentPluginAuthTypes"] = "declarative-agent-plugin-auth-types";
...
class TelemetryUtils {
    ...
    fillInErrorProperties(props, error) {
        ...
        if (error.name === "ScriptExecutionError" || error.name === "ScriptTimeoutError") {
            // don't send error message and error stack for these two types of error for the sake of complience issue
            props[TelemetryProperty.ErrorMessage] = "";
            props[TelemetryProperty.ErrorStack] = "";
        }
