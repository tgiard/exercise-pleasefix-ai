...
function loadTranslationFile(translationFolder, locale) {
    ...
    if (json) {
        ...
        if (existing) {
            LocaleStringMap.set(locale, Object.assign(Object.assign({}, existing), json));
        }
        else {
