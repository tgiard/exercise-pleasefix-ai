import { APIPluginManifest, APIPluginManifestLatest } from "../generated-types";
...
export declare const RuntimeType: {
    readonly [K in RuntimeTypeValue]: K;
};
/**
 ...
 * ```
 */
export declare class APIPluginManifestWrapper extends BaseManifest<APIPluginManifest> {
    private constructor();
    /**
     ...
     */
    static read(filePath: string): Promise<APIPluginManifestWrapper>;
    /**
     ...
     */
    addOpenApiRuntime(specUrl: string, authType?: "None" | "OAuthPluginVault" | "ApiKeyPluginVault", runForFunctions?: string[]): this;
    /**
     ...
     */
    cloneWith(changes: Partial<APIPluginManifest> & Record<string, unknown>): APIPluginManifestWrapper;
    /**
