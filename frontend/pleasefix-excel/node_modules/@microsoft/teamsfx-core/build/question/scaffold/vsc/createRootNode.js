...
exports.scaffoldQuestionForVSCode = exports.folderAndAppNameCondition = exports.languageNode = exports.getDefaultLanguage = exports.getLanguageOptions = exports.LanguageOptionMap = void 0;
...
function getLanguageOptions(inputs) {
    ...
    if (inputs[questionNames_1.QuestionNames.ProjectType] === ProjectTypeOptions_1.ProjectTypeOptions.teamsAgentsAndApps().id) {
        const pythonOptionIndex = languageOptions.findIndex((option) => option.id === constants_1.ProgrammingLanguage.PY);
        if (pythonOptionIndex !== -1) {
            languageOptions[pythonOptionIndex] = Object.assign(Object.assign({}, languageOptions[pythonOptionIndex]), { description: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.option.description.preview") });
        }
    }
        ...
        children: [
            {
                ...
                children: [
                    ...
                    (0, customEngineAgentNode_1.getCustomEngineAgentNode)(),
                    (0, teamsProjectTypeNode_1.getTeamsProjectNode)(),
