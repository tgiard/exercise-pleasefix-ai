                ...
                children: [
                    {
                        ...
                        children: [
                            ...
                            featureFlags_1.featureFlagManager.getBooleanValue(featureFlags_1.FeatureFlags.KiotaNPMIntegration)
                                ? (0, commonNodes_1.apiSpecWithSearchNode)()
                                : (0, commonNodes_1.apiSpecNode)((inputs) => inputs[questionNames_1.QuestionNames.ActionType] === CapabilityOptions_1.ActionStartOptions.apiSpec().id),
                            (0, teamsProjectTypeNode_1.MCPServerTypeNode)(),
                        ],
                    },
                ],
            },
