...
function foundryEndpointQuestion() {
    return {
        type: "text",
        name: constants_3.QuestionNames.FoundryEndpoint,
        title: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.foundry.endpoint.title"),
        placeholder: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.foundry.endpoint.placeholder"),
    };
}
exports.foundryEndpointQuestion = foundryEndpointQuestion;
function foundryAgentIdQuestion() {
    return {
        type: "text",
        name: constants_3.QuestionNames.FoundryAgentId,
        title: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.foundry.agentId.title"),
        placeholder: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.foundry.agentId.placeholder"),
    };
}
exports.foundryAgentIdQuestion = foundryAgentIdQuestion;
