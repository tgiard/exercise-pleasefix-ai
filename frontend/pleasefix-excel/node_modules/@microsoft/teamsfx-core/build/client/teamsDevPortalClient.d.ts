...
export declare class TeamsDevPortalClient {
    ...
    removePermission(token: string, teamsAppId: string, userToRemove: AppUser): Promise<void>;
    ...
    createAADApp(token: string, displayName: string, signInAudience?: SignInAudience, serviceManagementReference?: string, isMicrosoftUser?: boolean): Promise<AADApplication>;
