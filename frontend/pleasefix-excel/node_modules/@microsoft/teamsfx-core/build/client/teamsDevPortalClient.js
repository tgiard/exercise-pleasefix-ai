...
class TeamsDevPortalClient {
    ...
    getEndpoint() {
        return this.regionEndpoint || (0, constants_1.getResourceServiceEndpoint)(constants_1.ResourceServiceType.TDP);
    }
    /**
    ...
    async importApp(token, file, overwrite = false) {
        ...
        try {
            ...
            if (response && response.data) {
                ...
                globalVars_1.TOOLS.logProvider.debug(`Received data from Developer Portal: ${JSON.stringify(app)}`);
                return app;
            }
            else {
    ...
    async removePermission(token, teamsAppId, userToRemove) {
        ...
        app.userList = (_a = app.userList) === null || _a === void 0 ? void 0 : _a.filter((user) => user["aadId"] !== userToRemove.aadId);
        let requester;
        try {
            ...
            if (!response ||
                !response.data ||
                this.checkUser(response.data, userToRemove)) {
    ...
    async createAADApp(token, displayName, signInAudience = signInAudience_1.SignInAudience.AzureADMyOrg, serviceManagementReference, isMicrosoftUser = false) {
        ...
        try {
            ...
            if (axios_1.default.isAxiosError(err) && err.response) {
                if (((_b = (_a = err.response.data) === null || _a === void 0 ? void 0 : _a.error) === null || _b === void 0 ? void 0 : _b.code) === constants_4.aadErrorCode.signInAudienceNotAllowedAsPerAppPolicy) {
                    throw new signInAudienceNotAllowedError_1.SignInAudienceNotAllowedError("TeamsDevPortalClient", (_c = err.response.data.error) === null || _c === void 0 ? void 0 : _c.message, isMicrosoftUser);
                }
            }
    ...
    handleBotFrameworkError(e, apiName) {
        ...
        if (((_a = e.response) === null || _a === void 0 ? void 0 : _a.status) === commonConstant_1.HttpStatusCode.NOTFOUND) {
            ...
            throw new errors_2.BotFrameworkForbiddenResultError(e);
        }
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", Promise)
], TeamsDevPortalClient.prototype, "removePermission", null);
tslib_1.__decorate([
    (0, hooks_1.hooks)([(0, globalVars_1.ErrorContextMW)({ source: "Teams", component: "TeamsDevPortalClient" })]),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, String, Object]),
