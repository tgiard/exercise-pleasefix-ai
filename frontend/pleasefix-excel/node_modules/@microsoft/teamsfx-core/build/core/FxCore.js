...
const utils_2 = require("../component/driver/share/utils");
...
const constants_4 = require("../question/constants");
...
class FxCore extends FxCore_declarativeAgent_1.FxCoreDeclarativeAgentPart {
    ...
    async createProject(inputs) {
        ...
        if (inputs[constants_4.QuestionNames.ProjectType] === ProjectTypeOptions_1.ProjectTypeOptions.startWithGithubCopilot().id) {
            return (0, teamsfx_api_1.ok)({ projectPath: "", shouldInvokeTeamsAgent: true });
        }
        inputs[constants_4.QuestionNames.Scratch] = constants_4.ScratchOptions.yes().id;
        ...
        if (inputs.teamsAppFromTdp) {
            if ((0, utils_3.containsUnsupportedFeature)(inputs.teamsAppFromTdp)) {
                ...
                context.telemetryReporter.sendTelemetryEvent(telemetry_2.CoreTelemetryEvent.CreateFromTdpStart, {
                    [telemetry_2.CoreTelemetryProperty.TdpTeamsAppFeatures]: (0, utils_3.getFeaturesFromAppDefinition)(inputs.teamsAppFromTdp).join(","),
    ...
    async createProjectByCustomizedGenerator(inputs, generator) {
        ...
        if (undefined === appName)
            return (0, teamsfx_api_1.err)(new common_2.MissingRequiredInputError(constants_4.QuestionNames.AppName));
        const validateResult = jsonschema.validate(appName, {
            pattern: constants_4.AppNamePattern,
        });
        if (validateResult.errors && validateResult.errors.length > 0) {
            return (0, teamsfx_api_1.err)(new common_2.InputValidationError(constants_4.QuestionNames.AppName, validateResult.errors[0].message));
        }
    ...
    async createSampleProject(inputs) {
        const context = (0, globalVars_1.createContext)();
        inputs[constants_4.QuestionNames.Scratch] = constants_4.ScratchOptions.no().id;
        const res = await coordinator_1.coordinator.create(context, inputs);
        inputs.projectPath = context.projectPath;
        return res;
    }
    ...
    async uninstall(inputs) {
        switch (inputs[constants_4.QuestionNames.UninstallMode]) {
            case constants_4.QuestionNames.UninstallModeManifestId:
                return await this.uninstallByManifestId(inputs);
            case constants_4.QuestionNames.UninstallModeEnv:
                return await this.uninstallByEnv(inputs);
            case constants_4.QuestionNames.UninstallModeTitleId:
    ...
    async uninstallByManifestId(inputs) {
        const manifestId = inputs[constants_4.QuestionNames.ManifestId];
        if (!manifestId) {
            return (0, teamsfx_api_1.err)(new common_2.MissingRequiredInputError("manifest-id", "FxCore"));
        }
        const uninstallOptions = inputs[constants_4.QuestionNames.UninstallOptions];
        const m356AppOption = uninstallOptions === null || uninstallOptions === void 0 ? void 0 : uninstallOptions.includes(constants_4.QuestionNames.UninstallOptionM365);
        const tdpOption = uninstallOptions === null || uninstallOptions === void 0 ? void 0 : uninstallOptions.includes(constants_4.QuestionNames.UninstallOptionTDP);
        const botOption = uninstallOptions === null || uninstallOptions === void 0 ? void 0 : uninstallOptions.includes(constants_4.QuestionNames.UninstallOptionBot);
        if (m356AppOption) {
    ...
    async uninstallByTitleId(inputs) {
        const titleId = inputs[constants_4.QuestionNames.TitleId];
        if (!titleId) {
    ...
    async uninstallM365App(titleId, manifestId) {
        ...
        const sideloadingTokenRes = await globalVars_1.TOOLS.tokenProvider.m365TokenProvider.getAccessToken({
            scopes: (0, constants_3.MosServiceScope)(),
        });
    ...
    async deployAadManifest(inputs) {
        ...
        const manifestTemplatePath = inputs[constants_4.QuestionNames.AadAppManifestFilePath];
    ...
    async addWebpart(inputs) {
        ...
        const args = {
            manifestPath: inputs[constants_4.QuestionNames.ManifestPath],
            localManifestPath: inputs[constants_4.QuestionNames.LocalTeamsAppManifestFilePath],
            spfxFolder: inputs[constants_4.QuestionNames.SPFxFolder],
            webpartName: inputs[constants_4.QuestionNames.SPFxWebpartName],
            framework: inputs[constants_4.QuestionNames.SPFxFramework],
            spfxPackage: constants_4.SPFxVersionOptionIds.installLocally,
        };
        const Context = (0, utils_4.createDriverContext)(inputs);
    ...
    async removeSharedAccess(inputs, ctx) {
        ...
        const parseRes = await (0, utils_2.parseShareAppActionYamlConfig)(inputs.projectPath);
        if (parseRes.isErr()) {
    ...
    async shareApplication(inputs, ctx) {
        const operation = inputs[constants_4.QuestionNames.ShareOperation];
        const scope = inputs[constants_4.QuestionNames.ShareScope];
        let emails = [];
        if (scope === share_1.ShareScopeOption.ShareAppWithSpecificUsers ||
            ...
            emails = inputs[constants_4.QuestionNames.UserEmail].split(",").map((e) => e.trim());
            if (emails.length > constants_4.MAX_EMAIL_NUMBER) {
        ...
        if (operation === share_1.ShareOperationOption.RemoveShareAccessFromUsers) {
            return (0, share_2.removeShareAccess)(mosToken, sharedTitleId, emails);
        }
        else if (scope === share_1.ShareScopeOption.ShareAppWithTenantUsers) {
            return (0, share_2.shareWithTenant)(mosToken, sharedTitleId);
        }
        else if (scope === share_1.ShareScopeOption.ShareAppWithSpecificUsers) {
            return (0, share_2.addSharedUsers)(mosToken, sharedTitleId, emails);
        }
        else {
    ...
    async executeUserTask(func, inputs) {
        ...
        if (func.method === "addSso") {
            ...
            inputs[constants_4.QuestionNames.Features] = constants_2.SingleSignOnOptionItem.id;
    ...
    async convertAadToNewSchema(inputs) {
        const manifestTemplatePath = inputs[constants_4.QuestionNames.AadAppManifestFilePath];
        const projectPath = inputs[constants_4.QuestionNames.ProjectPath];
    ...
    async deployTeamsManifest(inputs, ctx) {
        inputs.manifestTemplatePath = inputs[constants_4.QuestionNames.TeamsAppManifestFilePath];
        const context = (0, globalVars_1.createContext)();
    ...
    async validateApplication(inputs) {
        ...
        else if (inputs[constants_4.QuestionNames.ValidateMethod] === constants_4.TeamsAppValidationOptions.testCases().id) {
    ...
    async syncManifest(inputs) {
        const context = (0, utils_4.createDriverContext)(inputs);
        const projectPath = inputs[constants_4.QuestionNames.ProjectPath];
        const env = inputs[constants_4.QuestionNames.Env];
        const teamsAppId = inputs[constants_4.QuestionNames.TeamsAppId];
        const args = {
    ...
    async createAppPackage(inputs) {
        ...
        const teamsAppManifestFilePath = inputs === null || inputs === void 0 ? void 0 : inputs[constants_4.QuestionNames.TeamsAppManifestFilePath];
        const driver = typedi_1.Container.get("teamsApp/zipAppPackage");
        const args = {
            manifestPath: teamsAppManifestFilePath,
            outputZipPath: (_a = inputs[constants_4.QuestionNames.OutputZipPathParamName]) !== null && _a !== void 0 ? _a : 
            // eslint-disable-next-line @typescript-eslint/restrict-template-expressions
            `${inputs.projectPath}/${teamsfx_api_1.AppPackageFolderName}/${teamsfx_api_1.BuildFolderName}/appPackage.${process.env
                .TEAMSFX_ENV}.zip`,
            outputFolder: (_b = inputs[constants_4.QuestionNames.OutputManifestParamName]) !== null && _b !== void 0 ? _b : 
            // eslint-disable-next-line @typescript-eslint/restrict-template-expressions
    ...
    async previewWithManifest(inputs) {
        ...
        const hub = inputs[constants_4.QuestionNames.M365Host];
        const manifestFilePath = inputs[constants_4.QuestionNames.TeamsAppManifestFilePath];
        const context = (0, globalVars_1.createContext)();
    ...
    async createEnv(inputs) {
        return this.createEnvCopyV3(inputs[constants_4.QuestionNames.NewTargetEnvName], inputs[constants_4.QuestionNames.SourceEnvName], inputs.projectPath);
    }
    ...
    async copilotPluginAddAPI(inputs) {
        const newOperations = inputs[constants_4.QuestionNames.ApiOperation];
        const url = inputs[constants_4.QuestionNames.ApiSpecLocation];
        const manifestPath = inputs[constants_4.QuestionNames.ManifestPath];
        const context = (0, globalVars_1.createContext)();
        ...
        try {
            ...
            const specParser = new m365_spec_parser_1.SpecParser(url, (0, helper_2.getParserOptions)(m365_spec_parser_1.ProjectType.SME));
            ...
            if (authNames.size >= 1) {
                for (const authName of authNames) {
                    await (0, helper_2.injectAuthAction)(inputs.projectPath, [...authNames][0], authNamesDict[authName], outputApiSpecPath, false);
                }
            }
            let pluginPath;
            const generateResult = await (0, helper_2.generateFromApiSpec)(specParser, manifestPath, inputs, context, "copilotPluginAddAPI", m365_spec_parser_1.ProjectType.SME, {
            ...
            if (generateResult.value.warnings && generateResult.value.warnings.length > 0) {
                const warnSummary = await (0, helper_2.generateScaffoldingSummary)(generateResult.value.warnings, manifestRes.value, path.relative(inputs.projectPath, outputApiSpecPath), pluginPath === undefined ? undefined : path.relative(inputs.projectPath, pluginPath), inputs.projectPath);
                if (warnSummary) {
            ...
            if (e instanceof m365_spec_parser_1.SpecParserError) {
                error = (0, helper_2.convertSpecParserErrorToFxError)(e);
            }
            else {
    ...
    async copilotPluginListOperations(inputs) {
        const res = await (0, helper_2.listOperations)((0, globalVars_1.createContext)(), inputs.apiSpecUrl, inputs, inputs.includeExistingAPIs, inputs.shouldLogWarning);
        if (res.isErr()) {
    ...
    async regeneratePlugin(inputs) {
        ...
        // Will be used if generating from API spec
        let authNameAndSchemes = [];
        const specPath = inputs[constants_4.QuestionNames.ApiSpecLocation].trim();
        ...
        const destinationPluginManifestPath = inputs[constants_4.QuestionNames.SelectPluginManifest];
        const destinationApiSpecPath = inputs[constants_4.QuestionNames.SelectOpenAPISpecFromPlugin];
        const generateRes = await (0, helper_2.generateFromApiSpec)(undefined, teamsManifestPath, inputs, context, teamsfx_api_1.Stage.RegeneratePlugin, m365_spec_parser_1.ProjectType.Copilot, {
            destinationApiSpecFilePath: destinationApiSpecPath,
            pluginManifestFilePath: destinationPluginManifestPath,
        }, inputs[constants_4.QuestionNames.ApiSpecLocation].trim(), true);
        if (generateRes.isErr()) {
            return (0, teamsfx_api_1.err)(generateRes.error);
        }
        const warnings = generateRes.value.warnings;
        if (warnings && warnings.length > 0) {
            const warnSummary = await (0, helper_2.generateScaffoldingSummary)(warnings, manifestRes.value, path.relative(projectPath, destinationApiSpecPath), path.relative(projectPath, destinationPluginManifestPath), projectPath);
            context.logProvider.info(warnSummary + "\n");
        }
        for (const authNameAndScheme of authNameAndSchemes) {
        ...
        const declarativeAgentManifesRes = await CopilotGptManifestUtils_1.copilotGptManifestUtils.readCopilotGptManifestFile(declarativeAgentManifestPath);
        ...
        const actionId = inputs[constants_4.QuestionNames.SelectPluginId];
        if (inputs.platform === teamsfx_api_1.Platform.VSCode) {
    ...
    async metaOSExtendToDA(inputs, workDir) {
        const context = (0, globalVars_1.createContext)();
        inputs[constants_4.QuestionNames.Scratch] = constants_4.ScratchOptions.yes().id;
        inputs[constants_4.QuestionNames.TemplateName] = templateNames_1.TemplateNames.DeclarativeAgentMetaOSUpgradeProject;
        inputs[constants_4.QuestionNames.OfficeAddinFolder] = workDir;
        const res = await coordinator_1.coordinator.create(context, inputs);
        if (res.isOk()) {
            inputs.projectPath = res.value.projectPath;
        }
    ...
    async addKnowledge(inputs) {
        ...
        const agent = teamsManifest.copilotExtensions
            ? (_a = teamsManifest.copilotExtensions.declarativeCopilots) === null || _a === void 0 ? void 0 : _a[0]
            : (_c = (_b = teamsManifest.copilotAgents) === null || _b === void 0 ? void 0 : _b.declarativeAgents) === null || _c === void 0 ? void 0 : _c[0];
        if (!(agent === null || agent === void 0 ? void 0 : agent.file)) {
            return (0, teamsfx_api_1.err)(results_1.AppStudioResultFactory.UserError(errors_1.AppStudioError.TeamsAppRequiredPropertyMissingError.name, errors_1.AppStudioError.TeamsAppRequiredPropertyMissingError.message("declarativeAgents", teamsManifestPath)));
        }
        ...
        let result;
        const knowledgeSource = inputs[constants_4.QuestionNames.KnowledgeSource];
        switch (knowledgeSource) {
            case constants_4.KnowledgeSourceOptions.webSearch().id:
                result = await this.addWebSearchKnowledge(context, inputs, agentManifestPath);
                break;
            case constants_4.KnowledgeSourceOptions.oneDriveSharePoint().id:
                result = await this.addOneDriveSharePointKnowledge(inputs, agentManifestPath);
                break;
            case constants_4.KnowledgeSourceOptions.graphConnector().id:
                result = await this.addGCKnowledge(inputs, agentManifestPath);
                break;
            case constants_4.KnowledgeSourceOptions.embeddedKnowledge().id:
    ...
    async kiotaRegenerate(inputs) {
        ...
        const declarativeCopilotManifest = declarativeCopilotManifesRes.value;
        const pluginManifestFilePath = inputs[constants_4.QuestionNames.ActionManifestPath];
        let actionId = "";
        (_d = declarativeCopilotManifest.actions) === null || _d === void 0 ? void 0 : _d.forEach((action) => {
        ...
        if (!actionId) {
            let suffix = 1;
            actionId = `action_${suffix}`;
            const existingActionIds = (_e = declarativeCopilotManifest.actions) === null || _e === void 0 ? void 0 : _e.map((action) => action.id);
            while (existingActionIds === null || existingActionIds === void 0 ? void 0 : existingActionIds.includes(actionId)) {
                suffix += 1;
                actionId = `action_${suffix}`;
            }
            const addActionRes = await CopilotGptManifestUtils_1.copilotGptManifestUtils.addAction(declarativeCopilotManifestPath, actionId, (0, utils_3.normalizePath)(path.relative(appPackageFolder, pluginManifestFilePath), true));
            if (addActionRes.isErr()) {
                return (0, teamsfx_api_1.err)(addActionRes.error);
            }
        }
        // 1. Get registration id and update plugin manifest
        const pluginManifestPath = inputs[constants_4.QuestionNames.ActionManifestPath].trim();
        ...
        await (0, helper_2.generateAdaptiveCardInPluginManifestForKiota)(pluginManifestFilePath, specPath, context);
    ...
    async addAuthAction(inputs) {
        ...
        const context = (0, globalVars_1.createContext)();
        try {
            const pluginManifestPath = inputs[constants_4.QuestionNames.PluginManifestFilePath];
            const apiSpecRelativePath = inputs[constants_4.QuestionNames.ApiSpecLocation];
            const apiOperation = inputs[constants_4.QuestionNames.ApiOperation];
            const authName = inputs[constants_4.QuestionNames.AuthName];
            const apiSpecPath = path.normalize(path.join(path.dirname(pluginManifestPath), apiSpecRelativePath));
            const authType = inputs[constants_4.QuestionNames.ApiAuth];
            let authParameters = {
                apis: apiOperation,
            };
            if (authType === constants_4.AddAuthActionAuthTypeOptions.oauth().id) {
                const oauthAuthorizationUrl = inputs[constants_4.QuestionNames.OAuthAuthorizationUrl];
                const oauthTokenUrl = inputs[constants_4.QuestionNames.OAuthTokenUrl];
                const oauthRefreshUrl = inputs[constants_4.QuestionNames.OAuthRefreshUrl];
                const oauthScopes = inputs[constants_4.QuestionNames.OAuthScope];
                const enablePKCEStr = inputs[constants_4.QuestionNames.OauthPKCE];
                const scopeArr = this.parseScope(oauthScopes);
                authParameters = Object.assign(Object.assign({}, authParameters), { authorizationUrl: oauthAuthorizationUrl, tokenUrl: oauthTokenUrl, refreshUrl: oauthRefreshUrl ? oauthRefreshUrl : undefined, scopes: scopeArr, enablePKCE: enablePKCEStr === "true" });
            }
            else if (authType === constants_4.AddAuthActionAuthTypeOptions.apiKey().id) {
                const apiKeyIn = inputs[constants_4.QuestionNames.ApiKeyIn];
                const apiKeyName = inputs[constants_4.QuestionNames.ApiKeyName];
                authParameters = Object.assign(Object.assign({}, authParameters), { in: apiKeyIn, name: apiKeyName });
            }
            else if (authType === constants_4.AddAuthActionAuthTypeOptions.microsoftEntra().id) {
                const oauthScopes = inputs[constants_4.QuestionNames.OAuthScope];
                const scopeArr = this.parseScope(oauthScopes);
                authParameters = Object.assign(Object.assign({}, authParameters), { authorizationUrl: "https://login.microsoftonline.com/${{TEAMS_APP_TENANT_ID}}/oauth2/v2.0/authorize", tokenUrl: "https://login.microsoftonline.com/${{TEAMS_APP_TENANT_ID}}/oauth2/v2.0/token", refreshUrl: undefined, scopes: scopeArr });
            }
            // Update openapi spec
            ...
            let authTypeScheme;
            switch (authType) {
                case constants_4.AddAuthActionAuthTypeOptions.apiKey().id:
                case constants_4.AddAuthActionAuthTypeOptions.bearerToken().id:
                default:
                    authTypeScheme = constant_1.APIKeyAuthType;
                    break;
                case constants_4.AddAuthActionAuthTypeOptions.oauth().id:
                    authTypeScheme = constant_1.OAuthAuthType;
                    break;
                case constants_4.AddAuthActionAuthTypeOptions.microsoftEntra().id:
            ...
            if (addAuthActionRes === null || addAuthActionRes === void 0 ? void 0 : addAuthActionRes.registrationIdEnvName) {
                ...
                (_a = pluginManifest.runtimes) === null || _a === void 0 ? void 0 : _a.forEach((runtime) => {
                    ...
                    if (runtime.type === "OpenApi" &&
                        ((_a = runtime.auth) === null || _a === void 0 ? void 0 : _a.type) === "None" &&
                        ((_b = runtime.spec) === null || _b === void 0 ? void 0 : _b.url) === apiSpecRelativePath) {
                        runtime.run_for_functions = (_c = runtime.run_for_functions) === null || _c === void 0 ? void 0 : _c.filter((value) => !!!apiOperation.includes(value));
                    }
                });
                pluginManifest.runtimes = (_b = pluginManifest.runtimes) === null || _b === void 0 ? void 0 : _b.filter((runtime) => {
                    var _a;
                    return !!runtime.run_for_functions && ((_a = runtime.run_for_functions) === null || _a === void 0 ? void 0 : _a.length) > 0;
                });
                (_c = pluginManifest.runtimes) === null || _c === void 0 ? void 0 : _c.push({
                    type: "OpenApi",
                    auth: {
            ...
            if (authType === constants_4.AddAuthActionAuthTypeOptions.microsoftEntra().id) {
            ...
            const error = (0, common_2.assembleError)(err);
    ...
    async setSensitivityLabel(inputs) {
        const declarativeAgentManifestPath = inputs[constants_4.QuestionNames.DeclarativeAgentManifestPath];
        ...
        return await (0, fileLocker_1.withFileLock)(declarativeAgentManifestPath, async () => {
            ...
            const selectedLabel = inputs[constants_4.QuestionNames.SensitivityLabel];
    ...
    parseAuthNameAndScheme(listResult, inputs) {
        ...
        const result = [];
        for (const api of inputs[constants_4.QuestionNames.ApiOperation]) {
    ...
    async addOneDriveSharePointKnowledge(inputs, agentManifestPath) {
        ...
        const sharePointItem = (_a = inputs.oneDriveSharePointItem) === null || _a === void 0 ? void 0 : _a[0];
        if (sharePointItem &&
            inputs[constants_4.QuestionNames.SearchType] !== constants_4.KnowledgeSearchTypeOptions.allOneDriveSharepoint().id) {
            if (sharePointItem.url) {
                oneDriveSharePointUrls = { url: sharePointItem.url };
            }
            else {
                oneDriveSharePointIds = Object.assign(Object.assign({ site_id: sharePointItem.siteId, web_id: sharePointItem.webId }, (sharePointItem.listId && { list_id: sharePointItem.listId })), (sharePointItem.uniqueId && { unique_id: sharePointItem.uniqueId }));
            }
        }
    ...
    async addWebSearchKnowledge(context, inputs, agentManifestPath) {
        ...
        if (inputs[constants_4.QuestionNames.SearchType] !== constants_4.KnowledgeSearchTypeOptions.allWeb().id) {
            webSearchUrl = {
    ...
    async addGCKnowledge(inputs, agentManifestPath) {
        ...
        let connectionIds;
        if (inputs[constants_4.QuestionNames.GCInput]) {
            connectionIds = [inputs[constants_4.QuestionNames.GCInput]];
        }
        else {
            connectionIds = inputs[constants_4.QuestionNames.GCList];
        }
    ...
    async addEmbeddedKnowledge(inputs) {
        const manifestFilePath = inputs[constants_4.QuestionNames.ManifestPath];
        const filePath = inputs[constants_4.QuestionNames.EmbeddedKnowledgeFiles];
    ...
    showAddKnowledgeSuccessMessage(context, inputs, agentManifestPath, knowledgeSource) {
        if (knowledgeSource === constants_4.KnowledgeSourceOptions.embeddedKnowledge().id) {
        ...
        if (inputs.platform === teamsfx_api_1.Platform.VSCode) {
            ...
            void context.userInteraction
                ...
                if (userRes.isOk() && userRes.value === viewAgentManifest) {
                    ...
                    void ((_b = (_a = globalVars_1.TOOLS === null || globalVars_1.TOOLS === void 0 ? void 0 : globalVars_1.TOOLS.ui) === null || _a === void 0 ? void 0 : _a.openFile) === null || _b === void 0 ? void 0 : _b.call(_a, agentManifestPath));
                }
            });
        }
        else {
...
tslib_1.__decorate([
    (0, hooks_1.hooks)([
        (0, globalVars_1.ErrorContextMW)({ component: "FxCore", stage: teamsfx_api_1.Stage.metaOSExtendToDA }),
        errorHandler_1.ErrorHandlerMW,
        (0, questionMW_1.QuestionMW)("metaOSExtendToDA"),
    ]),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, String]),
    tslib_1.__metadata("design:returntype", Promise)
], FxCore.prototype, "metaOSExtendToDA", null);
tslib_1.__decorate([
    (0, hooks_1.hooks)([
