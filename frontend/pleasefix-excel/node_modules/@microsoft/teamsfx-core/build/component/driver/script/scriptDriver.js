...
exports.parseSetOutputCommand = exports.convertScriptErrorToFxError = exports.bufferToString = exports.getStderrHandler = exports.executeCommand = exports.scriptDriver = exports.ScriptDriver = exports.defaultShell = void 0;
...
async function executeCommand(command, projectPath, logProvider, ui, workingDirectory, env, shell, timeout, redirectTo) {
    const workingDir = pathUtils_1.pathUtils.resolveFilePath(projectPath, workingDirectory);
    env = env || {};
    if (ui === null || ui === void 0 ? void 0 : ui.runCommand) {
        ...
        if (res.isErr()) {
            return (0, teamsfx_api_1.err)(convertScriptErrorToFxError(res.error, command));
        }
        ...
        return (0, teamsfx_api_1.ok)([outputString, outputObject]);
    }
    ...
    return new Promise((resolve) => {
        ...
        if (redirectTo) {
            appendFile = pathUtils_1.pathUtils.resolveFilePath(projectPath, redirectTo);
        }
