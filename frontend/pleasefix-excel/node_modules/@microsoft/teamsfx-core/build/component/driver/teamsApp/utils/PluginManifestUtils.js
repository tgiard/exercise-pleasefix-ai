...
class PluginManifestUtils {
    ...
    async validateAgainstSchema(plugin, path, context) {
        ...
        try {
            const schemaErrors = await teamsfx_api_1.ManifestUtil.validateManifest(manifestRes.value);
    ...
    async validateLocalMCPPluginRuntimes(manifest) {
        ...
        for (const runtime of localPluginRuntimes) {
            ...
            // 2. run_for_functions entries must match tool names in MCP server
            (_a = runtime.run_for_functions) === null || _a === void 0 ? void 0 : _a.forEach((funcName, funcIdx) => {
            ...
            (_b = manifest.functions) === null || _b === void 0 ? void 0 : _b.forEach((func, funcIdx) => {
            ...
            // 4. Functions cannot redefine parameters—must match MCP server
            (_c = runtime.run_for_functions) === null || _c === void 0 ? void 0 : _c.forEach((funcName) => {
                var _a;
                const manifestFunc = (_a = manifest.functions) === null || _a === void 0 ? void 0 : _a.find((f) => f.name === funcName);
    ...
    validateFunctionParameters(manifestFunc, mcpTool, funcName) {
        var _a, _b, _c, _d;
        const errors = [];
        const manifestParams = ((_a = manifestFunc.parameters) === null || _a === void 0 ? void 0 : _a.properties) || {};
        const mcpParams = ((_b = mcpTool.inputSchema) === null || _b === void 0 ? void 0 : _b.properties) || {};
        const manifestRequired = ((_c = manifestFunc.parameters) === null || _c === void 0 ? void 0 : _c.required) || [];
        const mcpRequired = ((_d = mcpTool.inputSchema) === null || _d === void 0 ? void 0 : _d.required) || [];
