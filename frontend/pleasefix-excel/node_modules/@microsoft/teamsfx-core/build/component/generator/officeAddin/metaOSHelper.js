...
class MetaOSHelper {
    ...
    static async unifyProjectID(projectFolder) {
        ...
        if (await fs_extra_1.default.pathExists(envFilePath)) {
            ...
            await fs_extra_1.default.ensureDir(path_1.default.join(projectFolder, ENV_FOLDER));
            const envContent = `TEAMS_APP_ID=${newUUID}\n`;
            await fs_extra_1.default.writeFile(envFilePath, envContent, { encoding: "utf8" });
        }
