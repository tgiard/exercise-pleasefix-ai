...
exports.setGeneralSensitivityLabel = exports.isApiLimitError = exports.simplifyAxiosError = exports.convertToUrl = exports.convertToLangKey = exports.runWithLimitedConcurrency = exports.getSampleFileInfo = exports.downloadDirectory = exports.zipFolder = exports.getSampleInfoFromName = exports.renderTemplateFileName = exports.renderTemplateFileData = exports.unzip = exports.fetchZipFromUrl = exports.getTemplateZipUrlByVersion = exports.getTemplateLatestVersion = exports.getTemplateUrl = void 0;
...
function getTemplateVSUrl(name) {
    ...
    return getTemplateZipUrlByVersion(name, templates_config_json_1.default.vsversion, templates_config_json_1.default.vstagPrefix);
}
    ...
    for (const token of tokens) {
        ...
        if (token[0] === "name" && (view[value] === undefined || view[value] === null)) {
            ...
            if (Array.isArray(view[token[1]])) {
                rootView = Object.assign(Object.assign({}, view), view[token[1]][0]);
            }
            else if (typeof view[token[1]] === "object") {
                rootView = Object.assign(Object.assign({}, view), view[token[1]]);
            }
...
async function setGeneralSensitivityLabel(context, declarativeAgentManifestPath) {
    ...
    try {
        const loginStatusRes = await ((_b = (_a = context.tokenProvider) === null || _a === void 0 ? void 0 : _a.m365TokenProvider) === null || _b === void 0 ? void 0 : _b.getStatus({
            scopes: [constants_1.ListSensitivityLabelScope],
        }));
        if (!loginStatusRes || loginStatusRes.isErr()) {
            (_c = context.logProvider) === null || _c === void 0 ? void 0 : _c.info((0, localizeUtils_1.getDefaultString)("error.listSensitivityLabel.tokenFailed", loginStatusRes === null || loginStatusRes === void 0 ? void 0 : loginStatusRes.error.message));
            return;
        }
        if (loginStatusRes.value.status != teamsfx_api_1.signedIn) {
            (_d = context.logProvider) === null || _d === void 0 ? void 0 : _d.info((0, localizeUtils_1.getDefaultString)("core.listSensitivityLabel.notLogin"));
            return;
        }
        if (loginStatusRes.value.token == undefined) {
            (_e = context.logProvider) === null || _e === void 0 ? void 0 : _e.info((0, localizeUtils_1.getDefaultString)("error.listSensitivityLabel.tokenUndefined"));
            return;
        }
        ...
        if (declarativeAgentManifestRes.isErr()) {
            (_f = context.logProvider) === null || _f === void 0 ? void 0 : _f.info((0, localizeUtils_1.getDefaultString)("error.readDeclarativeAgentManifest.failed", declarativeAgentManifestRes.error));
            return;
        }
        ...
        if (writeRes.isErr()) {
            (_g = context.logProvider) === null || _g === void 0 ? void 0 : _g.info((0, localizeUtils_1.getDefaultString)("error.writeDeclarativeAgentManifest.failed", writeRes.error));
            return;
        }
    }
    catch (error) {
        (_h = context.logProvider) === null || _h === void 0 ? void 0 : _h.info((0, localizeUtils_1.getDefaultString)("error.setGeneralSensitivityLabel.failed", error.message));
    }
}
