...
/// <reference types="node" />
import { Context as FxContext, Platform } from "@microsoft/teamsfx-api";
import AdmZip from "adm-zip";
import { AxiosError } from "axios";
import { SampleConfig, SampleUrlInfo } from "../../common/samples";
export declare function getTemplateUrl(programmingLanguage: string, getLatestVersion: () => Promise<string>, platform?: Platform): Promise<string | undefined>;
export declare function getTemplateLatestVersion(tryLimits?: number, timeoutInMs?: number): Promise<string>;
export declare function getTemplateZipUrlByVersion(name: string, version: string, prefex: string): string;
...
export declare function setGeneralSensitivityLabel(context: FxContext, declarativeAgentManifestPath: string): Promise<void>;
