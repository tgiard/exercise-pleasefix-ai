...
class PathUtils {
    getAvailableYmlFilePath(projectPath) {
    ...
    getYmlFilePath(projectPath, env, silent = false) {
        ...
        if (featureFlags_1.featureFlagManager.getBooleanValue(featureFlags_1.FeatureFlags.GenerateConfigFiles)) {
            ...
            if (fs_extra_1.default.pathExistsSync(availableYmlFilePath)) {
    ...
    async getEnvFolderPath(projectPath, env = "dev") {
        var _a;
        const ymlFilePath = this.getYmlFilePath(projectPath, env);
