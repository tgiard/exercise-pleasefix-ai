...
const constants_3 = require("../driver/aad/utility/constants");
...
let AadCollaboration = class AadCollaboration {
    ...
    async grantPermission(ctx, objectId, userObjectId) {
        try {
            ...
            const result = [
                {
                    name: constants_3.permissionsKeys.name,
                    type: constants_3.permissionsKeys.type,
                    roles: [constants_3.permissionsKeys.owner],
                    resourceId: objectId,
                },
            ];
            ...
            const result = [
                {
                    name: constants_3.permissionsKeys.name,
                    type: constants_3.permissionsKeys.type,
                    roles: isAadOwner ? [constants_3.permissionsKeys.owner] : [constants_3.permissionsKeys.noPermission],
                    resourceId: objectId,
                },
            ];
            return (0, teamsfx_api_1.ok)(result);
            ...
            const result = [
                {
                    ...
                    roles: [constants_4.Constants.PERMISSIONS.admin],
...
let AgentCollaboration = class AgentCollaboration {
    ...
    async grantPermission(ctx, titleId, userInfo) {
        const mosTokenRes = await this.tokenProvider.getAccessToken({
            scopes: (0, constants_2.MosServiceScope)(),
        });
...
AgentCollaboration = tslib_1.__decorate([
